############################################################################################################################
#
# objective_function_carb_vect.R     28 January 2020
#
# Copyright (C) 2020 Naomi Radke
#
#
#
# This function calculates the net carbon storage in above-ground biomass and wood products based on the forest growth 
...
#
#
# objective_function_carb_vect.R is free software: you can redistribute it and/or modify
