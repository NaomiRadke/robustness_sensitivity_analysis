############################################################################################################################
#
# objective_function_parallel.R     28 January 2020
#
# Copyright (C) 2020 Naomi Radke
#
#
#
# This function calculates the NPV of timber yield and the net carbon storage based on the forest growth model
# output data (stand volume growth (m3/ha) and harvested volume (m3/ha) in 5-year intervals).
# It can be sourced for robustness analysis.
#
#
#
# objective_function_parallel.R is free software: you can redistribute it and/or modify
